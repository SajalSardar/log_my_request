        ...
        <div class="md:basis-2/3 sm:basis-full">
            <div class="border border-slate-300 p-5 rounded">
                ...
                <div class="grid md:grid-cols-1 sm:grid-cols-1 sm:gap-1 md:gap-4 p-2 w-full ">
                    ...
                    <div wire:ignore>
                        <textarea wire:ignore cols="30" id="editor" rows="10" wire:model.lazy='form.request_description' class="w-full py-3 text-base font-normal font-inter border border-slate-400 rounded" placeholder="Add description here.."></textarea>
