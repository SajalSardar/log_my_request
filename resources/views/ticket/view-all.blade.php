<x-app-layout>
    <div class="relative overflow-x-auto">
        <table class="w-full overflow-x-auto !py-10">
            ...
            <tbody class="mt-5">
                ...
                <tr class="rounded shadow">
                    ...
                    <td class="p-2" style="max-width:120px">
                        <span class="font-normal text-gray-400">{{ Helper::humanReadableDate($each?->due_date) }}</span>
                    </td>
                    <td class="p-2">
                    ...
                    <td class="relative">
                        ...
                        <div id="action-{{ $each->id }}"
                            class="shadow-lg z-40 absolute top-5 right-16"
                            style="display: none">
                            <ul>
