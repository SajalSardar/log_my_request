                        ...
                        <div class="block" id="tab-detail">
                            <div class="grid lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-1 sm:gap-1 md:gap-5">
                                <div class="col-span-2">
                                    ...
                                    <div class="my-3 p-5 border border-slate-200 text-base-400 rounded">
                                        <div class="flex flex-wrap">
                                            <div class="basis-full sm:basis-full md:basis-1/2"
                                                ...
                                                <ul>
                                                    <li>
                                                        ...
                                                        <span
                                                            class="font-sm font-normal font-inter">#{{ $ticket?->user->id }}</span>
                                                    </li>
                                                    <li>
                                            ...
                                            <div
                                                class="basis-full sm:basis-full md:basis-1/2  sm:px-0 1 md:pl-10 lg:pl-6">
                                                <ul>
                                                    <li>
                                ...
                                <div>
                                    ...
                                    <div class="mt-3">
                                        <form
                                            action="{{ route('admin.ticket.logUpdate', ['ticket' => $ticket->id]) }}"
                                            method="POST">
                                            @csrf
                                                                ...
                                                                <x-forms.select-input name="team_id" id="team">
                                                                    ...
                                                                    @foreach ($teams as $each)
                                                                        <option value="{{ $each->id }}"
                                                                            @selected(old('team_id', $ticket?->team_id) == $each?->id)>
                                                                            {{ $each->name }}</option>
                                                                    @endforeach
                                                                </x-forms.select-input>
                                            ...
                                            <tbody>
                                                @forelse ($ticketStatusWise as $each)
                                                    <tr style="border:1px solid #DDDDDD">
                                                        ...
                                                        <td class="p-2">
                                                            <span
                                                                class="font-inter font-normal text-slate-500 text-sm">
                                                                #{{ $each?->id }}
                                                            </span>
                                                        </td>
                                                        <td class="p-2">
                                                        ...
                                                        <td class="relative">
                                                            <button onclick="toggleAction({{ $each?->id }})"
                                                                ...
                                                                <svg width="24" height="24"
                                                                    ...
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <path d="M11.9922 12H12.0012" stroke="#666666"
                                                                        stroke-width="2.5" stroke-linecap="round"
                                                                        stroke-linejoin="round"></path>
                                                                    <path d="M11.9844 18H11.9934" stroke="#666666"
                                                                        stroke-width="2.5" stroke-linecap="round"
                                                                        stroke-linejoin="round"></path>
                                                                    <path d="M12 6H12.009" stroke="#666666"
                                                                        stroke-width="2.5" stroke-linecap="round"
                                                                        stroke-linejoin="round"></path>
                                                                </svg>
                                                            </button>
                                                            <div id="action-{{ $each->id }}"
                                                                class="shadow-lg z-30 absolute top-5 right-16"
                                                                style="display: none">
                                                                <ul>
                                                                    <li class="px-5 py-1 text-center"
                                                                        style="background: #FFF4EC;color:#F36D00">
                                                                        <a
                                                                            href="{{ route('admin.ticket.edit', ['ticket' => $each?->id]) }}">Edit</a>
                                                                    </li>
                                                                    <li class="px-5 py-1 text-center bg-white">
                                                                        <a
                                                                            href="{{ route('admin.ticket.show', ['ticket' => $each?->id]) }}">View</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </td>
