    ...
    public function displayListDatatable(Request $request)
    {
        ...
        return DataTables::of($team)
            ...
            ->editColumn('status', function ($team) {
                ...
                $class  = $team->status == '1' ? 'bg-inProgress-400/15 !text-inProgress-400' : 'bg-open-400/15 !text-open-400';
            ...
            ->addColumn('action_column', function ($team) {
                ...
                return
                    '<div class="relative pl-10">
                        <button onclick="toggleAction(' . $team->id . ')" class="p-3 hover:letter-slate-100 rounded-full">
