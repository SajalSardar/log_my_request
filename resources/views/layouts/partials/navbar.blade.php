    ...
    <div class="navbar-wrapper">
        ...
        <div class="profile relative">
            <div class="toggle-menu-button flex justify-center items-center">
                <img src="{{ asset('assets/images/profile.png') }}" alt="profile" width="35" width="35" style="border-radius: 50%">
                <svg width="15" height="15" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                </svg>

            </div>
            <div class="toggle-menu absolute z-50 p-3 shadow-lg w-[200px] rounded bg-white sm:right-12 z-50" style="top: 46px;display:none">
                <ul>
                    <li class="py-2">
