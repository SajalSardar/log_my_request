    ...
    <table class="w-full table-fixed">
        <thead class="w-full bg-slate-100 mb-5">
            <tr>
                ...
                <th class="text-start ps-10 py-2">Source</th>
        ...
        <tbody class="mt-5">
            @forelse ($sources as $source)
                <tr class="rounded shadow">
                    ...
                    <td class="p-10 font-normal text-gray-400">{{ $source->id }}</td>
                    <td class="p-10 font-normal text-gray-400">{{ $source->title }}</td>
                    <td class="p-10 font-normal text-gray-400">{{ $source->status == 1 ? 'Active' : 'Deactive' }}</td>
