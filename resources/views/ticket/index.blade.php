        ...
        <table class="w-full overflow-x-auto">
            <tbody class="mt-5">
                @forelse ($tickets as $each)
                    @if ($each->name)
                        <tr class="main-row" style="cursor: pointer;border-bottom:1px solid #dadada"
                            ...
                            <td colspan="14" class="text-black font-inter font-semibold py-3">
                                <div class="flex justify-between">
                                    ...
                                    <div class="status">
                                        <a href="{{ route('admin.ticket.viewAll', ['ticket_status_id' => $each?->id]) }}"
                                        ...
                                        <tr>
                                            ...
                                            <td class="p-2 font-normal text-gray-400">
                                                @if (strtolower(trim($each->name)) === 'in progress')
                                                    <x-buttons.primary
                                                        class="!px-2 font-inter font-bold bg-process-400">
                                                        {{ $each->name }}
                                                    </x-buttons.primary>
                                            ...
                                            <td class="p-2">
                                                <span
                                                    class="font-normal text-gray-400">{{ $ticket?->source?->title }}</span>
                                            </td>
                                            <td class="p-2">
