<div>
    <div class="grid lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-1 sm:gap-1 md:gap-5">
        <div class="col-span-2 mt-3">
            <div class="mt-3 py-4">
                <form action="{{ route('admin.conversation.ticket.conversation', ['ticket' => $ticket?->id]) }}"
        ...
        <div class="row-span-2">
            <div class="flex gap-2">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    <path d="M7 7H7.01" stroke="#3D3D3D" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" />
                </svg>
                <h3 class="font-inter font-semibold text-base">Request Information</h3>
            </div>

            <div class="border border-slate-200 rounded px-14 py-5 mt-3">
                <div class="flex justify-center">
                    <img src="{{ asset('assets/images/profile.jpg') }}" width="100" height="100"
                        style="border-radius: 50%;border:1px solid #eee" alt="profile">
                </div>
                <div class="mt-5">
                    <ul>
                        <li class="mb-3">
                        ...
                        <li class="mb-3">
                            ...
                            <span
                                class="font-sm font-normal font-inter">{{ $ticket?->user->requester_type?->name }}</span>
                        </li>
                        <li class="mb-3">
                            <span class="font-sm font-semibold font-inter">Created at: </span>
                            <span
                                class="font-sm font-normal font-inter">{{ Helper::ISOdate($ticket?->created_at) }}</span>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="mb-4">
                    ...
                    @foreach ($chat as $each)
                        <div class="flex items-center gap-2">
                            <img src="{{ asset('assets/images/profile.jpg') }}" width="40" height="40"
                                style="border-radius: 50%;border:1px solid #eee" alt="profile">
                        ...
                        <div class="-mt-2">
                            ...
                            <div class="replay-{{ $each->id }} mb-3 reply-box"
                                style="opacity: 0; max-height: 0; overflow: hidden; transition: opacity 0.3s ease, max-height 0.3s ease;">
                                <form action="{{ route('admin.conversation.replay', ['conversation' => $each->id]) }}"
                                    method="post">
                                    @csrf
                                    <textarea class="w-full rounded border border-slate-200" name="conversation" rows="3" cols="30"
                                    ...
                                    <div class="pl-14">
                                        <div class="flex items-center gap-2">
                                            <img src="{{ asset('assets/images/profile.jpg') }}" width="40"
                                                height="40" style="border-radius: 50%;border:1px solid #eee"
                                                alt="profile">
                                            <p class="text-base font-semibold font-inter">{{ $ticket->user->name }}
                                            </p>
                                        </div>
                                        <div class="pl-10 flex items-center gap-4 mb-3">
                                            ...
                                            <span class="flex">
                                                <p class="font-inter font-semibold text-base">
                                                    {{ date('h:i:a', strtotime($replay?->created_at)) }}</p>
                                            </span>
                                        </div>
                                    </div>
                                @endforeach
