                                            ...
                                            <div class="flex flex-row">
                                                <div class="md:basis-full sm:basis-full">
                                                    <div class="border border-slate-300 p-5 rounded">
                                                        ...
                                                        <div
                                                            class="grid lg:grid-cols-1 md:grid-cols-1 sm:grid-cols-1 sm:gap-1 md:gap-4">
                                                            <div class="p-2 w-full">
                                                                <x-forms.label for="request_title" required="yes">
                                                                    {{ __('Request Title') }}
                                                                </x-forms.label>
                                                                <x-forms.text-input wire:model="request_title"
                                                                    value="{{ $ticket?->title }}" type="text" />
                                                                <x-input-error :messages="$errors->get('request_title')" class="mt-2" />
                                                            </div>
                                                        </div>

                                                        <div
                                                            class="grid md:grid-cols-3 sm:grid-cols-1 sm:gap-1 md:gap-4">
                                                            <div class="p-2 w-full">
                                                                <x-forms.label for="requester_name" required='yes'>
                                                                    {{ __('Requester Name') }}
                                                                </x-forms.label>
                                                                <x-forms.text-input type="text" readonly
                                                            ...
                                                            <div class="p-2 w-full">
                                                                ...
                                                                <x-forms.text-input wire:model="requester_email"
                                                                    readonly type="email"
                                                            ...
                                                            <div class="p-2 w-full">
                                                                ...
                                                                <x-forms.text-input type="number" readonly
                                                                    wire:model='requester_phone'
                                                            ...
                                                            <div class="p-2 w-full">
                                                                ...
                                                                <x-forms.select-input wire:model="requester_type_id">
                                                                    ...
                                                                    @foreach ($requester_type as $each)
                                                                        <option @selected(old('requester_type_id', $ticket?->requester_type_id) == $each?->id)
                                                                            value="{{ $each->id }}">
                                                                            {{ $each?->name }}
                                                                        </option>
                                                                    @endforeach
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="p-2 w-full">
                                                                ...
                                                                <div class="mt-3">
                                                                    <x-forms.radio-input wire:model="priority"
                                                                        name="priority" class="ml-2"
                                                                        value="low" /> <span
                                                                        class="ml-2">Low</span>
                                                                    <x-forms.radio-input wire:model="priority"
                                                                        name="priority" class="ml-2"
                                                                        value="medium" /> <span
                                                                        class="ml-2">Medium</span>
                                                                    <x-forms.radio-input wire:model="priority"
                                                                        name="priority" class="ml-2"
                                                                        value="high" /> <span
                                                                        class="ml-2">High</span>
                                                                </div>
