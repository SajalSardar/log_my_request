    ...
    <div class="">
        ...
        <div class="-mt-2">
            <div class="flex gap-1 pl-14">
                <p class="text-base font-normal font-inter inline-block">Added a private note one week ago </p> <span>({{ date('l, d M, Y H:m:a', strtotime($note->created_at))}} )</span>
            </div>
            <div class="flex gap-1 items-center pl-14">
