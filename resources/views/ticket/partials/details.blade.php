...
<div class="flex items-center mt-9">
    <div class="flex items-center">
        ...
        <div class="custom_file flex flex-wrap gap-5">
            ...
            @php
            $filename = $image->filename ? explode('.', $image->filename) : explode('.', $image->url);
            $extension = $image->filename ? $filename[1] : end($filename);
                    ...
                    <button class="absolute -top-4 -right-4 bg-[#eee] hover:bg-[#d6d6d6] z-40 p-2 rounded-full">
                        <span>
                            <svg width="12" height="12" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7.5 2.5L5 5M5 5L2.5 7.5M5 5L7.5 7.5M5 5L2.5 2.5" stroke="#5C5C5C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </span>
                    </button>
                </form>
