<button {{ $attributes->merge(['type' => 'submit', 'class' => 'transition-colors hover:bg-primary-400 flex justify-center items-center gap-2 hover:text-gray-100 border border-slate-200 px-8 py-2 bg-gray-100 text-gray-500 rounded-lg']) }}>
