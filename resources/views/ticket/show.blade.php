                                            ...
                                            <div class="basis-full sm:basis-full md:basis-1/3 lg:basis-1/3 sm:px-0 md:px-10 lg:px-10 sm:mt-3" style="border-right:2px solid #ddd">
                                                <ul>
                                                    ...
                                                    <li>
                                                        ...
                                                        <span class="font-sm font-normal font-inter">{{ Helper::dayMonthYearHourMininteSecond($ticket?->created_at, true, true, true, true, true, true) }}</span>
                                                    </li>
                                                    <li>
                                    ...
                                    <div class="flex items-center mt-3">
                                        <div class="flex items-center">
                                            ...
                                            <div class="custom_file flex gap-5">
                                                <a href="#" style="width: 200px;" download class="flex justify-between px-1 py-1 border border-slate-300 rounded bg-gray-200">
                                                    <div class="flex items-center">
                                                        <span class="pr-1">
                                                ...
                                                <a href="#" style="width: 200px;" download class="flex justify-between px-1 py-1 border border-slate-300 rounded bg-gray-200">
                                                    <div class="flex items-center">
                                                        <span class="pr-1">
                                                            <svg width="30" height="30" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M19 11.5C19 10.6825 19 9.9306 18.8478 9.56306C18.6955 9.19552 18.4065 8.90649 17.8284 8.32843L13.0919 3.59188C12.593 3.093 12.3436 2.84355 12.0345 2.69575C11.9702 2.665 11.9044 2.63772 11.8372 2.61401C11.5141 2.5 11.1614 2.5 10.4558 2.5C7.21082 2.5 5.58831 2.5 4.48933 3.38607C4.26731 3.56508 4.06508 3.76731 3.88607 3.98933C3 5.08831 3 6.71082 3 9.95584V14.5C3 18.2712 3 20.1569 4.17157 21.3284C5.34315 22.5 7.22876 22.5 11 22.5H19M12 3V3.5C12 6.32843 12 7.74264 12.8787 8.62132C13.7574 9.5 15.1716 9.5 18 9.5H18.5" stroke="#333333" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                                <path d="M21 14.5H19C18.4477 14.5 18 14.9477 18 15.5V17M18 17V19.5M18 17H20.5M7 19.5V17.5M7 17.5V14.5H8.5C9.32843 14.5 10 15.1716 10 16C10 16.8284 9.32843 17.5 8.5 17.5H7ZM12.5 14.5H13.7857C14.7325 14.5 15.5 15.2462 15.5 16.1667V17.8333C15.5 18.7538 14.7325 19.5 13.7857 19.5H12.5V14.5Z" stroke="#333333" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                            </svg>
