        ...
        <tbody class="mt-5">
            @forelse ($ticketStatuses as $status)
                <tr class="rounded shadow">
                    ...
                    <td class="p-3 font-normal text-gray-400">{{ $status->id }}</td>
                    <td class="p-3 font-normal text-gray-400">{{ $status->name }}</td>
                    <td class="p-3 font-normal text-gray-400">{{ $status->status == 1 ? 'Active' : 'Deactive' }}</td>
