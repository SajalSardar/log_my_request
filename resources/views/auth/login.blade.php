        ...
        <div class="lg:grid sm:h-[850px] h-[500px] lg:grid-cols-12">
            <section
                ...
                <img alt="" src="{{ asset('assets/images/login-page-image.png') }}"
                    class="absolute lg:rounded-l-3xl sm:rounded-none inset-0 h-full w-full object-cover opacity-80" />
            </section>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="mt-8 grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6">
                            <p class="mt-4 text-sm text-gray-500 sm:mt-0">
                                ...
                                <a href="{{ route('register') }}" class="text-primary-400 underline font-bold">Sign
                                    Up</a>.
                            </p>
                        </div>
