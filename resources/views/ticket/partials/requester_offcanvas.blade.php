            ...
            <div class="border border-slate-300 p-2 rounded">
                ...
                <div class="grid sm:grid-cols-1 sm:gap-1 md:gap-4">
                    <div class="p-2 w-full">
                        ...
                        <x-forms.text-input type="text" name='requester_name' value=""
                            id="requester_name" />
                ...
                <div class="grid sm:grid-cols-1 sm:gap-1 md:gap-4">
                    <div class="p-2 w-full">
                        ...
                        <x-forms.text-input name="requester_email" type="email" value=""
                            id="requester_email" />
                ...
                <div class="grid sm:grid-cols-1 sm:gap-1 md:gap-4">
                    <div class="p-2 w-full">
                        ...
                        <x-forms.text-input type="number" name='requester_phone' value=""
                            id="requester_phone" />
