                                    ...
                                    <div>
                                        ...
                                        <div class="mt-4">
                                            <p class="text-base font-bold font-inter">
                                                ...
                                                Requests <a href="{{ route('admin.ticket.status.wise.list', ['ticket_status' => $ticket?->ticket_status->slug]) }}" class="float-right underline text-sm text-green-500">View All</a>
                                            </p>
