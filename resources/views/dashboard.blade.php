<x-app-layout>
    ...
    @role('super-admin')
        <div class="mb-8">
            <h1 class="text-3xl font-inter font-bold">Hello {{ auth()->user()->name }}!</h1>
            <p class="font-inter text-base font-normal text-[#3D3D3D]">Welcome to explore your dashboard here.</p>
        </div>
        <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="border border-slate-100 rounded px-11 py-10">
                <div class="flex justify-between items-center">
                    ...
                    <div class="mt-3">
                        <h4 class="font-inter text-2xl font-semibold text-black-400">12,500</h4>
                        <p class="text-sm font-inter font-normal text-black-400">Open Requests</p>
                    </div>
                </div>
            </div>
            <div class="border border-slate-100 rounded px-11 py-10">
            ...
            <div class="row-span-2 border border-slate-100 rounded px-11 py-10">
        ...
        <div class="border border-slate-100 rounded px-8 py-8 mt-5">
            <div class="grid sm:grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-6">
                ...
                <div>
                    <div class="flex justify-between items-center">
                        <h3 class="font-inter font-semibold text-sm">Request by Categories</h3>
                        <button class="flex border border-slate-100 justify-between items-center px-3 py-2 bg-transparent text-gray-500 rounded">
                            View All
                ...
                <div>
                    <div class="flex justify-between items-center">
                        <h3 class="font-inter font-semibold text-sm">Top 5 Agents</h3>
                        <button class="flex border border-slate-100 justify-between items-center px-3 py-2 bg-transparent text-gray-500 rounded">
                            View All
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7 17L17 7" stroke="#5C5C5C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <table class="w-full mt-5">
                        <thead class="w-full bg-[#F3F4F6]" style="border:1px solid #F3F4F6;border-radius:10px !important">
                            <th>Agents</th>
                            <th class="text-start">Resolved Requests</th>
                        </thead>
                ...
                <div>
                    <div class="flex justify-between items-center">
                        <h3 class="font-inter font-semibold text-sm">Top 5 Requesters</h3>
                        <button class="flex border border-slate-100 justify-between items-center px-3 py-2 bg-transparent text-gray-500 rounded">
                            View All
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7 17L17 7" stroke="#5C5C5C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <table class="w-full mt-5">
                        ...
                        <tbody>
                            <tr style="border:1px solid #ddd">
                                <td class="text-center">Requester Name</td>
                                <td class="text-start">5</td>
                            </tr>
                            <tr style="border:1px solid #ddd">
                                <td class="text-center">Requester Name</td>
